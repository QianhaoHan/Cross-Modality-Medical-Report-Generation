...
class AttModel(CaptionModel):
    ...
    def _sample_beam(self, fc_feats, att_feats, att_masks=None, retrival_ids=None, opt={}):
        ...
        p_fc_feats, p_att_feats, pp_att_feats, p_att_masks = self._prepare_feature(fc_feats, att_feats, att_masks, retrival_ids)
    ...
    def _sample(self, fc_feats, att_feats, att_masks=None, retrival_ids=None, update_opts={}):
        ...
        if beam_size > 1 and sample_method in ['greedy', 'beam_search']:
            return self._sample_beam(fc_feats, att_feats, att_masks, retrival_ids, opt)
        if group_size > 1:
