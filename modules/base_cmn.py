...
class BaseCMN(AttModel):
    ...
    def _prepare_feature(self, fc_feats, att_feats, retrival_ids, att_masks):
        att_feats, seq, att_masks, seq_mask = self._prepare_feature_forward(att_feats, att_masks, retrival_ids)
